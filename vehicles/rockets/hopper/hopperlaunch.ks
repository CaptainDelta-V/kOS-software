...
Local BoosterMaxPitchOver to 25.

Local launchProfileInitial to LaunchProfileModel(3, 6, 3, BoosterMaxPitchOver).
Local launchProfileSecondary to LaunchProfileModel(6, 1, 4, BoosterMaxPitchOver).
...
Local vesselType to VESSEL_TYPE_HOPPER.
...
Local flightStatus to FlightStatusModel("SUB HOPPER LAUNCH", "PRELAUNCH").
